<?php
    $arr_requests = [
        [
            ...
            'answer' => <<<STR
                        <p>
                        La recente <a href="http://curia.europa.eu/juris/document/document.jsf?text=&amp;docid=152065&amp;amppageIndex=0&amp;doclang=it&amp;mode=lst&amp;dir=&amp;occ=first&amp;part=1&amp;cid=276332">
        ...
        [
            ...
            'answer' => <<<STR
                        ...
                        <ol>
                            ...
                            <li class="innerli">Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li>
                            <li class="innerli">Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li></ol></li><li class="smANld">La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li></ol>
        ...
        [
            'request' => '<h3>Stabilire il paese associato al tuo account</h3>',
            'answer' => <<<STR
        ...
        [
            'request' => '<h2>Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?</h2>',
            'answer' => <<<STR
